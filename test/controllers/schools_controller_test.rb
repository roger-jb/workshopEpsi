...
class SchoolsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create school" do
    assert_difference('School.count') do
      post schools_url, params: { school: { campus_id: @school.campus_id, name: @school.name } }
    end
  ...
  test "should update school" do
    patch school_url(@school), params: { school: { campus_id: @school.campus_id, name: @school.name } }
